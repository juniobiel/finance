...
namespace FinanceApp.Identity.API.Controllers
{
    public class AuthController : MainController
    {
        ...
        public async Task<ActionResult> Register(UsuarioRegistro usuarioRegistro)
        {
            ...
            var existsUser = await _userCommandHandler.VerifyUserHandle(usuarioRegistro);
            ...
            var result = await _userCommandHandler.CreateUserHandle(usuarioRegistro);
            ...
            return CustomResponse(Ok("Usuario registrado com sucesso!"));
        }
        ...
        public async Task<ActionResult> Login( UsuarioLogin usuarioLogin )
        {
            ...
            var result = await _userCommandHandler.LoginUserHandle(usuarioLogin);
